            ...
            <div class="lwp_forms_login <?php echo esc_attr($class); ?>">
                ...
                if ($options['idehweb_sms_login']) {
                    ...
                    <form id="lwp_login" class="ajax-auth lwp-login-form-i <?php echo esc_attr($theClasses); ?>"
                        ...
                        ?>
                        <div class="lh1"><?php echo isset($localizationoptions['idehweb_localization_status']) ? esc_html($localizationoptions['idehweb_localization_title_of_login_form']) : (esc_html__('Login', 'login-with-phone-number')); ?></div>
                        <p class="status"></p>
